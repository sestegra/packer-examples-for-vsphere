/*
    DESCRIPTION:
    FreeBSD 13 variables using the Packer Builder for VMware vSphere (vsphere-iso).
*/
...
variable "vm_guest_os_name" {
  type        = string
  description = "The guest operating system name. Used for naming . (e.g. 'sles')"
}
...
variable "vm_guest_os_type" {
  type        = string
  description = "The guest operating system type, also know as guestid. (e.g. 'sles15_64Guest')"
}
